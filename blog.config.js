...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 15, // 更新缓存间隔 单位(秒)；即每个页面有60秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'OrcusYoung', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '普通临床医学菜鸟一枚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.orcusyoung.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, research', // 网站关键词 英文逗号隔开
